        ...
        <div style={{display: 'flex', flexDirection: 'column', gap: 48}}>
          ...
          <section>
            ...
            >
              ...
              <li style={{marginBottom: 8}}><strong>Browsing data:</strong> IP address, browser type, pages visited, and referring URL, collected automatically through cookies and analytics tools.</li>
              <li style={{marginBottom: 8}}><strong>Communications:</strong> any emails or messages you send us through our contact form.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            >
              ...
              <li style={{marginBottom: 8}}>Comply with legal obligations, prevent fraud, and enforce our terms.</li>
            </ul>
          </section>

          <section>
            <SectionHeading number="3" title="Cookies & Analytics" />
            <Paragraph>
          ...
          <section>
            ...
            <Paragraph>
              We share your information only with third parties necessary to operate our business:
            </Paragraph>
            <ul
              style={{
                fontFamily: FONT.inter,
            ...
            >
              <li style={{marginBottom: 8}}><strong>Shopify:</strong> our e-commerce platform, which processes orders and payments.</li>
          ...
          <section>
            ...
            <Paragraph>
              We use industry-standard security measures to protect your information, including SSL encryption for all data transmitted between your browser and our servers. Payment processing is handled by PCI-compliant providers. However, no method of transmission over the internet is 100% secure, and we cannot guarantee absolute security.
            </Paragraph>
          </section>
          ...
          <section>
            ...
            <Paragraph>
              We retain your personal information for as long as necessary to fulfill the purposes outlined in this policy, comply with legal obligations, resolve disputes, and enforce our agreements. Order records are retained for a minimum of 7 years for tax and legal compliance.
            </Paragraph>
          </section>
          ...
          <section>
            <SectionHeading number="8" title="California Residents (CCPA)" />
            <Paragraph>
              If you are a California resident, you have additional rights under the California Consumer Privacy Act (CCPA), including the right to know what personal information we collect and the right to request deletion. We do not sell personal information as defined by the CCPA.
            </Paragraph>
          </section>
