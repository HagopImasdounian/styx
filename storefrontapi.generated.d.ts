...
export type RootLocalizationQuery = {
  localization: {
    availableCountries: Array<
      Pick<StorefrontAPI.Country, 'isoCode'> & {
...
export type StyxPredictiveFallbackQuery = {
  products: {
    nodes: Array<
...
export type StyxPredictiveSearchQueryVariables = StorefrontAPI.Exact<{
  q: StorefrontAPI.Scalars['String']['input'];
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type StyxPredictiveSearchQuery = {
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query StyxPredictiveFallback(\n    $q: String!\n    $country: CountryCode\n    $language: LanguageCode\n  ) @inContext(country: $country, language: $language) {\n    products(first: 6, sortKey: RELEVANCE, query: $q) {\n      nodes {\n        id\n        handle\n        title\n        featuredImage {\n          url\n          altText\n        }\n        priceRange {\n          minVariantPrice {\n            amount\n            currencyCode\n          }\n        }\n      }\n    }\n  }\n': {
    ...
    variables: StyxPredictiveFallbackQueryVariables;
  };
  '#graphql\n  query StyxPredictiveSearch(\n    $q: String!\n    $country: CountryCode\n    $language: LanguageCode\n  ) @inContext(country: $country, language: $language) {\n    predictiveSearch(query: $q, limit: 6, types: [PRODUCT, COLLECTION]) {\n      products {\n        id\n        handle\n        title\n        featuredImage {\n          url\n          altText\n        }\n        priceRange {\n          minVariantPrice {\n            amount\n            currencyCode\n          }\n        }\n      }\n      collections {\n        id\n        handle\n        title\n      }\n    }\n  }\n': {
    return: StyxPredictiveSearchQuery;
    variables: StyxPredictiveSearchQueryVariables;
  };
}
