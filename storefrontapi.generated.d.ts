...
export type StyxHomepageSeoQueryVariables = StorefrontAPI.Exact<{
  [key: string]: never;
}>;

export type StyxHomepageSeoQuery = {
...
export type ChainCatNavCollectionsQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type ChainCatNavCollectionsQuery = {
  collections: {
    nodes: Array<
      Pick<StorefrontAPI.Collection, 'id' | 'title' | 'handle'> & {
        products: {nodes: Array<Pick<StorefrontAPI.Product, 'id'>>};
...
export type ChainsNavCollectionsQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type ChainsNavCollectionsQuery = {
  collections: {
    nodes: Array<
      Pick<StorefrontAPI.Collection, 'id' | 'title' | 'handle'> & {
        products: {nodes: Array<Pick<StorefrontAPI.Product, 'id'>>};
...
export type CollectionDetailsQuery = {
  collection?: StorefrontAPI.Maybe<
    ...
    > & {
      ...
      >;
      story_heading?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
      story_body?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
      era_label?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
      chapter_kicker?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
      products: {
        filters: Array<
...
export type StyxCollectionsIndexQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;
...
export type CompareSlugProductQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
  handle: StorefrontAPI.Scalars['String']['input'];
}>;

export type CompareSlugProductQuery = {
  product?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Product, 'id' | 'title' | 'handle'> & {
      ...
      chain_origin?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
      spec_weave?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
      spec_profile?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
...
export type CompareProductQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
  handle: StorefrontAPI.Scalars['String']['input'];
}>;

export type CompareProductQuery = {
  product?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Product, 'id' | 'title' | 'handle'> & {
      featuredImage?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Image, 'url' | 'altText' | 'width' | 'height'>
...
export type ShopCollectionQueryVariables = StorefrontAPI.Exact<{
  handle: StorefrontAPI.Scalars['String']['input'];
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type ShopCollectionQuery = {
  collection?: StorefrontAPI.Maybe<{
    products: {
      nodes: Array<
...
export type PrintProductQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
  handle: StorefrontAPI.Scalars['String']['input'];
}>;

export type PrintProductQuery = {
  product?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Product, 'id' | 'title' | 'handle'> & {
      featuredImage?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Image, 'url' | 'altText' | 'width' | 'height'>
      ...
      variants: {
        nodes: Array<
          Pick<StorefrontAPI.ProductVariant, 'sku' | 'weight'> & {
            image?: StorefrontAPI.Maybe<
              Pick<StorefrontAPI.Image, 'url' | 'altText' | 'width' | 'height'>
            >;
            selectedOptions: Array<
      ...
      >;
      chain_style?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
      original_sku?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
    }
  >;
...
export type ProductVariantFragment = Pick<
  StorefrontAPI.ProductVariant,
  'id' | 'availableForSale' | 'sku' | 'title' | 'weight'
> & {
...
> & {
  ...
  weight_grams?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  karat?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  ...
  >;
  chain_style?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  labor_cost?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  margin_percent?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  chain_origin?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  year_invented?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  roman_numeral?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  chain_blurb?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  story_heading?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  story_body?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  pull_quote?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  pull_quote_attr?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  spec_weave?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
...
export type ProductQuery = {
  product?: StorefrontAPI.Maybe<
    ...
    > & {
      ...
      weight_grams?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
      karat?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
      chain_thickness?: StorefrontAPI.Maybe<
      ...
      chain_style?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
      labor_cost?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
      margin_percent?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
      chain_origin?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
      year_invented?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
      roman_numeral?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
      chain_blurb?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
      story_heading?: StorefrontAPI.Maybe<
      ...
      story_body?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
      pull_quote?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
      pull_quote_attr?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
      spec_weave?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
      spec_profile?: StorefrontAPI.Maybe<
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query ChainCatNavCollections($country: CountryCode, $language: LanguageCode)\n  @inContext(country: $country, language: $language) {\n    collections(first: 50, sortKey: TITLE) {\n      nodes {\n        id\n        title\n        handle\n        products(first: 1) { nodes { id } }\n      }\n    }\n  }\n': {
    return: ChainCatNavCollectionsQuery;
    variables: ChainCatNavCollectionsQueryVariables;
  };
  '#graphql\n  query ChainsNavCollections($country: CountryCode, $language: LanguageCode)\n  @inContext(country: $country, language: $language) {\n    collections(first: 50, sortKey: TITLE) {\n      nodes {\n        id\n        title\n        handle\n        products(first: 1) { nodes { id } }\n      }\n    }\n  }\n': {
    return: ChainsNavCollectionsQuery;
    variables: ChainsNavCollectionsQueryVariables;
  };
  ...
  '#graphql\n  query CompareSlugProduct(\n    $country: CountryCode\n    $language: LanguageCode\n    $handle: String!\n  ) @inContext(country: $country, language: $language) {\n    product(handle: $handle) {\n      id\n      title\n      handle\n      featuredImage {\n        url\n        altText\n        width\n        height\n      }\n      variants(first: 100) {\n        nodes {\n          id\n          availableForSale\n          image {\n            url\n            altText\n            width\n            height\n          }\n          price {\n            amount\n            currencyCode\n          }\n          selectedOptions {\n            name\n            value\n          }\n          weight\n          weightUnit\n        }\n      }\n      karat: metafield(namespace: "chain", key: "karat") {\n        value\n      }\n      chain_thickness: metafield(namespace: "chain", key: "thickness") {\n        value\n      }\n      chain_construction: metafield(namespace: "chain", key: "construction") {\n        value\n      }\n      chain_style: metafield(namespace: "chain", key: "chain_style") {\n        value\n      }\n      chain_origin: metafield(namespace: "custom", key: "chain_origin") {\n        value\n      }\n      spec_weave: metafield(namespace: "custom", key: "spec_weave") {\n        value\n      }\n      spec_profile: metafield(namespace: "custom", key: "spec_profile") {\n        value\n      }\n      spec_clasp: metafield(namespace: "custom", key: "spec_clasp") {\n        value\n      }\n      spec_cast: metafield(namespace: "custom", key: "spec_cast") {\n        value\n      }\n    }\n  }\n': {
    return: CompareSlugProductQuery;
    variables: CompareSlugProductQueryVariables;
  };
